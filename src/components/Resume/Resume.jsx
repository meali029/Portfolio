...
const skills = [
  ...
  { name: 'GitHub', icon: <SiGithub className="text-white bg-black rounded-full p-[2px]" /> },
    ...
    >
      ...
      >
        <p className="text-lg mb-6">
          I’m a Full Stack Developer skilled in building modern, scalable, and interactive web
          apps using the <strong>MERN stack</strong>, <strong>Tailwind CSS</strong>, and
          tools like <strong>Framer Motion</strong>.
        </p>
        <p className="text-lg mb-6">
          From travel websites to LMS platforms, I love solving real-world problems through clean
          code, beautiful interfaces, and smooth user experiences.
        </p>
