    ...
    >
      ...
      >
        ...
        >
          ...
          Full Stack Developer and Software Engineering student based in
          Pakistan 🇵🇰. I build sleek, responsive, and futuristic web
          experiences.
        </p>
        <p
          className={`text-base md:text-lg leading-relaxed mb-4  ${
        ...
        >
          I use the MERN stack (MongoDB, Express, React, Node.js), styled with
          Tailwind, and I love experimenting with APIs, animations, and modern
          tooling.
        </p>
        <p
          className={`text-base md:text-lg leading-relaxed mb-4  ${
